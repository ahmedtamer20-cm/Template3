...
ScrollReveal().reveal('.landing img   ', {
      distance: '40px',
      origin: 'right',
      duration: 800,
       interval: 150,
 ...
 ScrollReveal().reveal('.logo  ', {
    ...
    ScrollReveal().reveal('.main-nav li', {
      distance: '40px',
      origin: 'top',
      duration: 800,
      interval: 150,
    ...
    ScrollReveal().reveal('.box , .box2 , .our-skills .skill .the-progress span , .work-steps .box3 , .events .info , .subscribe ,  .button ,  form , .videos , .stats , .discount .content  , .discount form ' , {
      distance: '40px',
      origin: 'right',
      duration: 500,
      interval: 150,
